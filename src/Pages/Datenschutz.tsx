  ...
  return (
    <>
      ...
      <p>
        ...
        <h2>8. Cookies</h2>
        <h3>8.1 Es werden keine Cookies verwendet</h3>
        <p>
        ...
        <h3>10.2 Recht auf Auskunft Art. 15 DS-GVO</h3>
        <p>
        ...
        <h3>10.3 Recht auf Berichtigung Art. 16 DS-GVO</h3>
        <p>
        ...
        <h3>10.4 Löschung Art. 17 DS-GVO</h3>
        <p>
        ...
        <h3>10.5 Einschränkung der Verarbeitung Art. 18 DS-GVO</h3>
        <p>
        ...
        <h3>10.6 Datenübertragbarkeit Art. 20 DS-GVO</h3>
        <p>
        ...
        <div style={{ border: "2px solid black" }}>
          <h3>10.7 Widerspruch Art. 21 DS-GVO</h3>
          <p>
        ...
        <h2>
          11. Routinemäßige Speicherung, Löschung und Sperrung von
        ...
        <h2>13. Aktualität und Änderung der Datenschutzerklärung</h2>
        <p>
        ...
        <p>
          ...
          unter "https://computer-extra.de/Datenschutz
        </p>
